"""
Script to extract mozhigal student access report weekly to create district-wise abstract and district-level abstract
"""
import sys
sys.path.append('../')
import pandas as pd
...
def get_se_stu_weekly_rpt(df, group_cols,agg_dict):
    """
