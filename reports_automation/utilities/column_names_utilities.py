...
perc_admitted_oosc = '% Students pending to be admitted'
to_be_admitted = 'To be admitted'
oosc_student_status = 'student_status'
not_admttd = 'Not Admitted'
stu_pen_to_admt = 'Students pending to be Admitted'
...
vocational_group_median = 'vocational_group_median'
...
vocational_group_std = 'vocational_group_std'
